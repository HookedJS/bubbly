...
class CustomDropdown extends React.Component {
  ...
  render() {
    ...
    const {classes, buttonText, buttonIcon, dropdownList, buttonProps, dropup, dropdownHeader, caret, hoverColor, dropPlacement, rtlActive, noLiPadding, innerDropDown, navDropdown} = this.props;
    ...
    const dropDownMenu = (
      <MenuList role="menu" className={classes.menuList}>
        ...
        {dropdownList.map((prop, key) => {
          if (prop.divider) {
            return <Divider key={key} onClick={() => this.handleCloseMenu("divider")} className={classes.dropdownDividerItem} />;
