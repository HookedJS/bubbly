...
// TODO: Upgrade to https://www.npmjs.com/package/sweetalert2-react-content to remove SweetAlert dependency on react-bootstrap
...
class SweetAlertPage extends React.Component {
  ...
  autoCloseAlert() {
    this.setState({
      alert: (
        <SweetAlert style={{display: "block", marginTop: "-100px"}} title="Auto close alert!" onConfirm={() => this.hideAlert()} showConfirm={false}>
        ...
        <Heading
          ...
          category={
            <span>
              ...
              <a target="_blank" href="https://github.com/djorg83" rel="noopener noreferrer">
                Daniel Jorgensen
              </a>
              . Please check out the{" "}
              <a href="https://github.com/djorg83/react-bootstrap-sweetalert" target="_blank" rel="noopener noreferrer">
                full documentation.
              </a>
              .
            </span>
            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  ...
                  <Button color="rose" onClick={this.titleAndTextAlert.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  ...
                  <Button color="rose" onClick={this.warningWithConfirmMessage.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  ...
                  <Button color="rose" onClick={this.warningWithConfirmAndCancelMessage.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
