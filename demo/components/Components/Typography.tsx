...
// core components
import Quote from "@theme/components/Typography/Quote";
import Muted from "@theme/components/Typography/Muted";
import Primary from "@theme/components/Typography/Primary";
import Info from "@theme/components/Typography/Info";
import Success from "@theme/components/Typography/Success";
import Warning from "@theme/components/Typography/Warning";
...
function Typography({...props}) {
  return (
    <div>
      <Heading textAlign="center" title="Material Dashboard Heading" category="Created using Roboto Font Family" />
      <Card>
        <CardBody>
