...
import SnackbarContent from "@theme/components/Snackbar/SnackbarContent";
import Button from "@theme/components/CustomButtons/Button";
import Snackbar from "@theme/components/Snackbar/Snackbar";
import Instruction from "@theme/components/Instruction/Instruction";
...
import noticeModal1 from "@theme/demo/assets/img/card-1.jpeg";
import noticeModal2 from "@theme/demo/assets/img/card-2.jpeg";
          ...
          <GridItem xs={12} sm={12} md={6}>
            <Card>
              <CardBody>
                ...
                <SnackbarContent message={"This is a notification with close button."} close color="info" />
                <br />
                <SnackbarContent
                  message={
            ...
            <Card>
              <CardBody>
                <div>
                  ...
                  <SnackbarContent message={'ROSE - This is a regular notification made with color="primary"'} close color="rose" />
                </div>
              </CardBody>
            </Card>
          </GridItem>
                ...
                <div>
                  <GridContainer justify="center">
                    <GridItem xs={12}>
                      <div className={classes.cardHeader + " " + classes.center}>
                        <h4 className={classes.cardTitle}>Notifications Places</h4>
                        <p className={classes.cardSubtitle}>Click to view notifications</p>
                      </div>
                    </GridItem>
                  </GridContainer>
                  <GridContainer justify="center">
                  ...
                  <GridContainer justify="center">
                    <GridItem xs={12} sm={12} md={12} className={classes.center}>
                      <div className={classes.cardHeader + " " + classes.center + " " + classes.modalSectionTitle}>
                        <h4 className={classes.cardTitle}>Modal</h4>
                      </div>
                      <Button color="primary" round className={classes.marginRight} onClick={() => this.handleClickOpen("classicModal")}>
                        Classic modal
                      </Button>
                      <Dialog
                        classes={{
                      ...
                      >
                        <DialogTitle id="classic-modal-slide-title" disableTypography className={classes.modalHeader}>
                          <Button justIcon className={classes.modalCloseButton} key="close" aria-label="Close" color="transparent" onClick={() => this.handleClose("classicModal")}>
                      ...
                      <Button color="info" round className={classes.marginRight} onClick={() => this.handleClickOpen("noticeModal")}>
                        Notice Modal
                      </Button>
                      <Dialog
                        classes={{
                      ...
                      >
                        <DialogTitle id="notice-modal-slide-title" disableTypography className={classes.modalHeader}>
                          <Button justIcon className={classes.modalCloseButton} key="close" aria-label="Close" color="transparent" onClick={() => this.handleClose("noticeModal")}>
                            <Close className={classes.modalClose} />
                          </Button>
                        ...
                        <DialogContent id="notice-modal-slide-description" className={classes.modalBody}>
                          <Instruction
                            ...
                            text={
                              <span>
                                The first step is to create an account at <Link to="/">Benevolent Tech</Link>. You can choose a social network or go for the classic version, whatever works best for
                                you.
                              </span>
                            }
                            image={noticeModal1}
                      ...
                      <Button color="rose" round className={classes.marginRight} onClick={() => this.handleClickOpen("smallModal")}>
                        Small alert modal
                      </Button>
                      <Dialog
                        classes={{
                      ...
                      >
                        <DialogTitle id="small-modal-slide-title" disableTypography className={classes.modalHeader}>
                          <Button justIcon className={classes.modalCloseButton} key="close" aria-label="Close" color="transparent" onClick={() => this.handleClose("smallModal")}>
                            <Close className={classes.modalClose} />
                          </Button>
                        </DialogTitle>
                        ...
                        <DialogActions className={classes.modalFooter + " " + classes.modalFooterCenter}>
                          <Button onClick={() => this.handleClose("smallModal")} color="transparent" className={classes.modalSmallFooterFirstButton}>
                            Never Mind
                          </Button>
                          <Button onClick={() => this.handleClose("smallModal")} color="success" simple className={classes.modalSmallFooterFirstButton + " " + classes.modalSmallFooterSecondButton}>
                            Yes
                          </Button>
                        </DialogActions>
                      </Dialog>
