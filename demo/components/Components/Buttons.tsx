        ...
        <CardBody>
          ...
          <GridContainer>
            ...
            <GridItem xs={12} sm={12} md={6}>
              ...
              <div className={classes.cardContentRight}>
                ...
                <Button justIcon round color="primary" className={classes.marginRight}>
          ...
          <GridContainer>
            <GridItem xs={12} sm={12} md={6}>
              ...
              <div className={classes.cardContentLeft}>
                <Pagination pages={[{text: 1}, {text: "..."}, {text: 5}, {text: 6}, {active: true, text: 7}, {text: 8}, {text: 9}, {text: "..."}, {text: 12}]} />
                <Pagination pages={[{text: "PREV"}, {text: 1}, {text: 2}, {active: true, text: 3}, {text: 4}, {text: 5}, {text: "NEXT"}]} color="info" />
              </div>
            </GridItem>
            <GridItem xs={12} sm={12} md={6}>
              <div className={classes.cardHeader}>
            ...
            <GridItem xs={12}>
              ...
              <div className={classes.cardContentBottom}>
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="twitter">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-twitter"} /> Connect with Twitter
                    </Button>
                  </GridItem>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="twitter" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-twitter"} />
                    </Button>
                  </GridItem>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="facebook">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-facebook-square"} /> Share · 2.2k
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="facebook" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-facebook-square"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="google">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-google-plus-g"} /> Share on Google+
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="google" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-google"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="linkedin">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-linkedin"} /> Connect with Linkedin
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon round color="linkedin">
                      <i className={classes.socialButtonsIcons + " fab fa-linkedin"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="linkedin" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-linkedin"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="pinterest">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-pinterest"} /> Pint it · 212
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon round color="pinterest">
                      <i className={classes.socialButtonsIcons + " fab fa-pinterest"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="pinterest" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-pinterest"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="youtube">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-youtube"} /> View on Youtube
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon round color="youtube">
                      <i className={classes.socialButtonsIcons + " fab fa-youtube-square"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="youtube" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-youtube-square"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="tumblr">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-tumblr-square"} /> Repost
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon round color="tumblr">
                      <i className={classes.socialButtonsIcons + " fab fa-tumblr-square"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="tumblr" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-tumblr-square"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="github">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-github"} /> Connect with Github
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="github" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-github"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="behance">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-behance-square"} /> Follow us
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon round color="behance">
                      <i className={classes.socialButtonsIcons + " fab fa-behance-square"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="behance" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-behance"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="dribbble">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-dribbble"} /> Find us on Dribble
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon round color="dribbble">
                      <i className={classes.socialButtonsIcons + " fab fa-dribbble"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="dribbble" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-dribbble"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={4} md={4}>
                    <Button color="reddit">
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-reddit"} /> Repost · 232
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                  ...
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon round color="reddit">
                      <i className={classes.socialButtonsIcons + " fab fa-reddit"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={1} md={1}>
                    <Button justIcon color="reddit" simple>
                      <i className={classes.socialButtonsIcons + " " + classes.marginRight + " fab fa-reddit"} />
                    </Button>
                  </GridItem>
                  <GridItem xs={12} sm={4} md={3}>
