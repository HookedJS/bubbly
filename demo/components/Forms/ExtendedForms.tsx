...
import CustomLinearProgress from "@theme/components/CustomLinearProgress/CustomLinearProgress";
import ImageUpload from "@theme/components/CustomUpload/ImageUpload";
            ...
            <Card>
              <CardBody>
                ...
                <GridContainer>
                  <GridItem xs={12} sm={12} md={6}>
                    <legend>Tags</legend>
                    <TagsInput value={this.state.tags} onChange={this.handleTags} tagProps={{className: "react-tagsinput-tag info"}} />
                  </GridItem>
                  <GridItem xs={12} sm={12} md={6}>
                    ...
                    <GridContainer>
                            ...
                            <CustomDropdown
                              ...
                              dropdownList={[
                                ...
                                <CustomDropdown
                                  ...
                                  dropPlacement="right-start"
                                  dropdownList={["Second Subsubmenu action 1", "Second Subsubmenu action 2"]}
                                />,
                              ]}
                            />,
                          ]}
                      ...
                      <GridItem xs={12} sm={6} md={6} lg={6} className={`${classes.mrAuto} ${classes.mlAuto}`}>
                        <CustomDropdown
                          dropup
                          buttonText="Dropup"
                          hoverColor="info"
