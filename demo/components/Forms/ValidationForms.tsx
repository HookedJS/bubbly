          ...
          <Card>
            ...
            <CardBody>
              <form>
                ...
                />
                <Button color="rose" onClick={this.registerClick} className={classes.registerButton}>
                  Register
                </Button>
              </form>
            </CardBody>
          ...
          <Card>
            ...
            <CardBody>
              <form>
                <GridContainer>
                  <GridItem xs={12} sm={2}>
                    <FormLabel className={classes.labelHorizontal}>Required Text</FormLabel>
                  </GridItem>
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "required", "length", 0),
                        type: "text",
                        endAdornment:
                ...
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "typeEmail", "email"),
                        type: "email",
                        endAdornment:
                ...
                <GridContainer>
                  <GridItem xs={12} sm={2}>
                    <FormLabel className={classes.labelHorizontal}>Number</FormLabel>
                  </GridItem>
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                ...
                <GridContainer>
                  <GridItem xs={12} sm={2}>
                    <FormLabel className={classes.labelHorizontal}>Equal to</FormLabel>
                  </GridItem>
                  <GridItem xs={12} sm={3}>
                    <CustomInput
                  ...
                  <GridItem xs={12} sm={3}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "equalTo", "equalTo", "whichEqualTo"),
                        type: "text",
                        endAdornment:
                          this.state.equalToState === "error" ? (
                            <InputAdornment position="end">
                ...
                <GridContainer>
                  ...
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "minLength", "length", 5),
                        type: "text",
                        endAdornment:
                  ...
                  <GridItem xs={12} sm={2}>
                    <FormLabel className={classes.labelHorizontal}>Max Length</FormLabel>
                  </GridItem>
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "maxLength", "max-length", 5),
                        type: "text",
                        endAdornment:
                  ...
                  <GridItem xs={12} sm={2}>
                    <FormLabel className={classes.labelHorizontal}>Range</FormLabel>
                  </GridItem>
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "range", "range", 6, 10),
                        type: "text",
                        endAdornment:
                  ...
                  <GridItem xs={12} sm={2}>
                    <FormLabel className={classes.labelHorizontal}>Min Value</FormLabel>
                  </GridItem>
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "minValue", "min-value", 6),
                        type: "text",
                        endAdornment:
                  ...
                  <GridItem xs={12} sm={2}>
                    <FormLabel className={classes.labelHorizontal}>Max Value</FormLabel>
                  </GridItem>
                  <GridItem xs={12} sm={7}>
                    <CustomInput
                      ...
                      inputProps={{
                        onChange: (event) => this.change(event, "maxValue", "max-value", 6),
                        type: "text",
                        endAdornment:
