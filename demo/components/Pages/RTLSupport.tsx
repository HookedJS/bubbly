...
import CustomTabs from "@theme/components/CustomTabs/CustomTabs";
...
import CardAvatar from "@theme/components/Card/CardAvatar";
import CardText from "@theme/components/Card/CardText";
import CardBody from "@theme/components/Card/CardBody";
import CardFooter from "@theme/components/Card/CardFooter";

import {rtlStories, rtlBugs, rtlWebsite, rtlServer} from "@theme/demo/var/general";

import image from "@theme/demo/assets/img/faces/card-profile1-square.jpg";

import {cardTitle, roseColor} from "@theme/MainStyles";
            ...
            <Card>
              <CardHeader color="warning" text>
                <CardText color="warning">
                  ...
                  <h4 className={classes.cardCategoryWhite}>بالإنزال وفي. خيار ومضى العمليات تم ذلك, تم معقل مرمى</h4>
                </CardText>
              </CardHeader>
              <CardBody>
                <Table
                  ...
                  tableHead={["وتم", "لأمريكية هذا", "شاسعالأمريكية", "الأمريكية "]}
                  tableData={[
              ...
              tabs={[
                {
                  tabName: "ضرب",
                  tabIcon: BugReport,
                  tabContent: <Tasks checkedIndexes={[0, 3]} tasksIndexes={[0, 1, 2, 3]} tasks={rtlBugs} />,
                },
                {
                  tabName: "السفن",
                  tabIcon: Code,
                  tabContent: <Tasks checkedIndexes={[0]} tasksIndexes={[0, 1]} tasks={rtlWebsite} />,
                },
                {
                  tabName: "فصل.",
                  tabIcon: Cloud,
                  tabContent: <Tasks checkedIndexes={[1]} tasksIndexes={[0, 1, 2]} tasks={rtlServer} />,
                },
              ]}
            />
          </GridItem>
              ...
              <GridItem xs={12} sm={12} lg={6}>
                <Card pricing>
                  <CardBody pricing>
                    ...
                    <p className={classes.cardDescription}>الأجل المتساقطة، من. عرض بسبب وأكثرها الاندونيسية بـ.</p>
              ...
              <GridItem xs={12} sm={12} lg={6}>
                <Card pricing plain>
                  <CardBody pricing plain>
                    ...
                    <h3 className={`${classes.cardTitle} ${classes.marginTop30}`}>قائمة</h3>
                    <p className={classes.cardCategory}>الأجل المتساقطة، من. عرض بسبب وأكثرها الاندونيسية بـ.</p>
                ...
                <Card testimonial>
                  ...
                  <CardBody>
                    <h5 className={classes.cardTestimonialDescription}>
                      بعد و وسوء الأحمر, دون عقبت الهادي أم, قد حول قادة حكومة يتعلّق. أخذ حصدت اوروبا أن, كلا مهمّات اسبوعين التخطيط عل. وإيطالي الأوروبي و نفس. صفحة احداث أضف ان, هو مرجع نهاية
                      لهيمنة كما. تم مايو لفشل المدن دول, جعل أن عسكرياً التّحول استرجاع.
                    </h5>
                  </CardBody>
