...
import {widgetStories, bugs, website, server} from "@theme/demo/var/general";
            ...
            <Card>
              <CardHeader color="warning" text>
                <CardText color="warning">
                  ...
                  <h4 className={classes.cardCategoryWhite}>New employees on 15th September, 2016</h4>
                </CardText>
              </CardHeader>
              <CardBody>
                <Table
              ...
              <GridItem xs={12} sm={12} lg={6}>
                <Card pricing plain>
                  <CardBody pricing plain>
                    ...
                    <h3 className={`${classes.cardTitle} ${classes.marginTop30}`}>FREE</h3>
